...
const gestionePartita = require('../shared/core/gestione_partita.js');

const moveDBArray = JSON.parse(fs.readFileSync(path.join(__dirname, '../shared/data/DB_mosse.json'), 'utf8'));
const moveDB = {};
...
const pkmnDBArray = JSON.parse(fs.readFileSync(path.join(__dirname, '../shared/data/DB_pokemon.json'), 'utf8'));
const pkmnDB = {};
